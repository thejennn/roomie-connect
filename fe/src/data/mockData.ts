...
- Xe buýt 88 đi qua`,
    ...
    district: 'Thạch Hòa',
    amenities: ['Điều hoà', 'WC khép kín', 'Wifi', 'Giường', 'Tủ quần áo', 'Bàn học', 'Nóng lạnh'],
...
Thích hợp cho cặp đôi hoặc người đi làm cần không gian riêng tư.`,
    ...
    district: 'Thạch Hòa',
    amenities: ['Điều hoà', 'WC khép kín', 'Wifi', 'Bếp riêng', 'Ban công', 'Nóng lạnh', 'Tủ bếp'],
...
Ưu tiên sinh viên năm 1-2, không hút thuốc.`,
    ...
    district: 'Thạch Thất',
    amenities: ['Wifi', 'Giường tầng', 'WC chung', 'Quạt trần', 'Tủ đồ cá nhân'],
...
Phù hợp cho người đi làm, cặp đôi, hoặc sinh viên năm cuối.`,
    ...
    district: 'Thạch Hòa',
    amenities: ['Điều hoà', 'WC khép kín', 'Wifi', 'Bếp từ', 'Máy giặt', 'Smart TV', 'Thang máy', 'Bảo vệ 24/7'],
    nearbyPlaces: ['FPT University', 'Lotte Mart', 'Phòng Gym', 'Cafe The Coffee House'],
    utilities: {
      electricity: 3500,
      water: 100000,
      internet: 0,
...
Ưu tiên sinh viên nữ hoặc người đi làm.`,
    ...
    district: 'Tân Xã',
    amenities: ['Điều hoà', 'WC khép kín', 'Wifi', 'Bảo vệ 24/7', 'Chỗ nấu ăn', 'Chỗ phơi đồ'],
...
Đang tìm 1 bạn nam hoặc nữ share nhà, ưu tiên người đi làm.`,
    ...
    district: 'Thạch Hòa',
    amenities: ['Điều hoà 2 chiều', 'WC khép kín', 'Wifi', 'Bếp chung', 'Phòng khách', 'Sân vườn'],
...
✅ Yên tĩnh, riêng tư tuyệt đối`,
    ...
    district: 'Thạch Hòa',
    amenities: ['Điều hoà', 'WC khép kín', 'Wifi', 'Bếp đầy đủ', 'Sân thượng', 'Thang máy', 'Smart Home'],
...
✅ Cách âm tốt, yên tĩnh`,
    ...
    district: 'Thạch Hòa',
    amenities: ['Điều hoà', 'WC khép kín', 'Wifi', 'Giường Nhật', 'Bàn học', 'Nóng lạnh', 'Tủ âm tường'],
...
✅ Chủ nhà là cô giáo, thân thiện`,
    ...
    district: 'Tân Xã',
    amenities: ['Điều hoà', 'Nóng lạnh', 'Wifi', 'Giường riêng', 'Tủ riêng', 'WC chung'],
...
✅ Hợp đồng dài hạn từ 1 năm`,
    ...
    district: 'Thạch Thất',
    amenities: ['3 Điều hoà', '2 WC', 'Wifi', 'Bếp đầy đủ', 'Phòng khách', 'Sân trước', 'Máy giặt'],
...
✅ Phù hợp cho ai cần tập trung học`,
    ...
    district: 'Thạch Hòa',
    amenities: ['Điều hoà', 'WC khép kín', 'Wifi', 'Giường', 'Bàn học lớn', 'View hồ'],
...
✅ Hồ bơi chung trong tòa nhà`,
    ...
    district: 'Thạch Hòa',
    amenities: ['Điều hoà', 'WC cao cấp', 'Wifi', 'Smart Home', 'Hồ bơi', 'Gym', 'Thang máy', 'Bảo vệ 24/7'],
